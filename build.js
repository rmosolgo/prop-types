...
if (cached_shape == null) cached_shape = nil;
      ...
      Opal.defn(self, '$generate_prop_type', function(key_name, props, current_depth, object_cache) {
        var $a, $b, $c, self = this, $case = nil, prop_type = nil, cache_key = nil, cached_shape = nil;
      ...
      return (Opal.defn(self, '$hash_to_prop_type', function(props, current_depth, object_cache) {
        ...
        return $rb_plus($rb_plus($rb_plus("React.PropTypes.shape({", ($a = ($b = keys).$map, $a.$$p = (TMP_2 = function(key){var self = TMP_2.$$s || this;
if (key == null) key = nil;
        return $rb_plus($rb_plus(next_indent, "" + (key) + ": "), self.$generate_prop_type(key, props['$[]'](key), $rb_plus(current_depth, 1), object_cache))}, TMP_2.$$s = self, TMP_2), $a).call($b).$join(",")), own_indent), "})");
      }), nil) && 'hash_to_prop_type';
    })($scope.base, null)
  })($scope.base)
};

...
/* Generated by Opal 0.9.2 */
Opal.modules["prop_types/cached_shape"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var self = $CachedShape = $klass($base, $super, 'CachedShape', $CachedShape);
      ...
      Opal.defn(self, '$offer_name', function(name) {
        var $a, self = this;

        if ((($a = self.unnamed) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.name = name;
          return self.unnamed = false;
          } else {
          return nil
        };
      });

      Opal.defn(self, '$increment', function() {
        var self = this;

        return self.uses_count = $rb_plus(self.uses_count, 1);
      });

      Opal.defn(self, '$to_var', function() {
      ...
      return (function(self) {
        ...
        return (Opal.defn(self, '$next_id', function() {
          var $a, self = this;
          if (self.id == null) self.id = nil;

          ((($a = self.id) !== false && $a !== nil) ? $a : self.id = 0);
          return self.id = $rb_plus(self.id, 1);
        }), nil) && 'next_id'
      })(Opal.get_singleton_class(self));
    })($scope.base, null)
  })($scope.base)
...
/* Generated by Opal 0.9.2 */
Opal.modules["prop_types/destructure"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$sort', '$uniq', '$flatten', '$scan', '$join', '$gsub']);
  return (function($base) {
    var $PropTypes, self = $PropTypes = $module($base, 'PropTypes');
    ...
    (function($base) {
      var $Destructure, self = $Destructure = $module($base, 'Destructure');

      var def = self.$$proto, $scope = self.$$scope;

      Opal.defs(self, '$create_header', function(base_shape, semicolon) {
        var self = this, required_fns = nil;

        required_fns = base_shape.$scan(/React\.PropTypes\.([A-Za-z]+)/).$flatten().$uniq().$sort();
        return "var {" + (required_fns.$join(", ")) + "} = React.PropTypes" + (semicolon);
      });

      Opal.defs(self, '$strip_globals', function(base_shape) {
        var self = this;

        return base_shape.$gsub("React.PropTypes.", "");
      });
    })($scope.base)
  })($scope.base)
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["prop_types/generator"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$generate_code', '$private', '$new', '$+', '$generate_prop_type', '$apply_shapes', '$reindent_object', '$create_header', '$strip_globals', '$===', '$[]', '$cache', '$hash_to_prop_type', '$offer_name', '$increment', '$id', '$raise', '$class', '$create', '$-', '$apply_sort', '$keys', '$join', '$map', '$sort']);
  return (function($base) {
    var $PropTypes, self = $PropTypes = $module($base, 'PropTypes');
    ...
    (function($base, $super) {
      ...
      def.to_js = def.example_props = def.semicolon = def.function_wrapper = def.destructure = def.is_required = def.dangling_comma = def.alphabetize = nil;
      Opal.defn(self, '$initialize', function(example_props, $kwargs) {
        var self = this, function_wrapper = nil, destructure = nil, semicolons = nil, alphabetize = nil, dangle_commas = nil, required = nil;
        ...
        if ((alphabetize = $kwargs.$$smap['alphabetize']) == null) {
          alphabetize = true
        }
        if ((dangle_commas = $kwargs.$$smap['dangle_commas']) == null) {
          dangle_commas = false
        }
        if ((required = $kwargs.$$smap['required']) == null) {
          required = true
        }
        ...
        self.dangling_comma = (function() {if (dangle_commas !== false && dangle_commas !== nil) {
          return ","
          } else {
          return ""
        }; return nil; })();
        self.semicolon = (function() {if (semicolons !== false && semicolons !== nil) {
          return ";"
          } else {
          return ""
        }; return nil; })();
        return self.is_required = (function() {if (required !== false && required !== nil) {
          return ".isRequired"
          } else {
          return ""
        }; return nil; })();
      ...
      Opal.defn(self, '$to_js', function() {
        ...
        return ((($a = self.to_js) !== false && $a !== nil) ? $a : self.to_js = self.$generate_code(self.example_props));
      });

      self.$private();

      Opal.cdecl($scope, 'ANY_PROP_TYPE', "React.PropTypes.any");

      Opal.cdecl($scope, 'BOOL_PROP_TYPE', "React.PropTypes.bool");

      Opal.cdecl($scope, 'NUMBER_PROP_TYPE', "React.PropTypes.number");

      Opal.cdecl($scope, 'STRING_PROP_TYPE', "React.PropTypes.string");

      Opal.defn(self, '$generate_code', function(props) {
        var $a, self = this, object_cache = nil, base_shape = nil, destructure_header = nil;

        object_cache = (($scope.get('PropTypes')).$$scope.get('ShapeCache')).$new();
        ...
        if ((($a = self.destructure) !== nil && (!$a.$$is_boolean || $a == true))) {
          destructure_header = $scope.get('Destructure').$create_header(base_shape, self.semicolon);
          base_shape = $scope.get('Destructure').$strip_globals(base_shape);
          base_shape = "" + (destructure_header) + "\n\n" + (base_shape);};
        return base_shape;
      });

      Opal.defn(self, '$generate_prop_type', function(key_name, props, current_depth, object_cache) {
        var $a, $b, TMP_1, self = this, $case = nil, cached_shape = nil;

        return (function() {$case = props;if ($scope.get('String')['$===']($case)) {return $rb_plus($scope.get('STRING_PROP_TYPE'), self.is_required)}else if ($scope.get('NilClass')['$===']($case)) {return $scope.get('ANY_PROP_TYPE')}else if ($scope.get('Numeric')['$===']($case)) {return $rb_plus($scope.get('NUMBER_PROP_TYPE'), self.is_required)}else if ($scope.get('TrueClass')['$===']($case) || $scope.get('FalseClass')['$===']($case)) {return $rb_plus($scope.get('BOOL_PROP_TYPE'), self.is_required)}else if ($scope.get('Array')['$===']($case)) {return $rb_plus($rb_plus($rb_plus("React.PropTypes.arrayOf(", self.$generate_prop_type(nil, props['$[]'](0), current_depth, object_cache)), ")"), self.is_required)}else if ($scope.get('Hash')['$===']($case)) {cached_shape = ($a = ($b = object_cache).$cache, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, prop_type = nil;
          if (self.semicolon == null) self.semicolon = nil;

        prop_type = self.$hash_to_prop_type(props, current_depth, object_cache);
          return (($scope.get('PropTypes')).$$scope.get('CachedShape')).$new(nil, prop_type, props, $hash2(["semicolon"], {"semicolon": self.semicolon}));}, TMP_1.$$s = self, TMP_1), $a).call($b, props);
        (($a = key_name !== false && key_name !== nil) ? cached_shape.$offer_name("" + (key_name) + "Shape") : key_name);
        cached_shape.$increment();
        return $rb_plus(cached_shape.$id(), self.is_required);}else {return self.$raise("Can't generate prop for " + (props) + " (" + (props.$class()) + ")")}})();
      });

      Opal.defn(self, '$hash_to_prop_type', function(props, current_depth, object_cache) {
        var $a, $b, TMP_2, self = this, own_indent = nil, next_indent = nil, keys = nil;

        own_indent = (($scope.get('PropTypes')).$$scope.get('Indent')).$create($rb_minus(current_depth, 1));
        next_indent = (($scope.get('PropTypes')).$$scope.get('Indent')).$create(current_depth);
        keys = self.$apply_sort(props.$keys());
        return $rb_plus($rb_plus($rb_plus($rb_plus("React.PropTypes.shape({", ($a = ($b = keys).$map, $a.$$p = (TMP_2 = function(key){var self = TMP_2.$$s || this;
if (key == null) key = nil;
        return $rb_plus($rb_plus(next_indent, "" + (key) + ": "), self.$generate_prop_type(key, props['$[]'](key), $rb_plus(current_depth, 1), object_cache))}, TMP_2.$$s = self, TMP_2), $a).call($b).$join(",")), self.dangling_comma), own_indent), "})");
      });

      return (Opal.defn(self, '$apply_sort', function(strings) {
        var $a, self = this;

        if ((($a = self.alphabetize) !== nil && (!$a.$$is_boolean || $a == true))) {
          return strings.$sort()
          } else {
          return strings
        };
...
/* Generated by Opal 0.9.2 */
Opal.modules["prop_types/indent"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  ...
  return (function($base) {
    ...
    (function($base) {
      var $Indent, self = $Indent = $module($base, 'Indent');

      var def = self.$$proto, $scope = self.$$scope;

      Opal.cdecl($scope, 'INDENT', "  ");

      Opal.defs(self, '$create', function(depth) {
        var self = this;

        return "\n" + ($rb_times($scope.get('INDENT'), depth));
      });

      Opal.defs(self, '$reindent_object', function(code, new_depth) {
...
/* Generated by Opal 0.9.2 */
Opal.modules["prop_types/shape_cache"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$join', '$sort', '$keys', '$[]', '$[]=', '$reverse', '$values', '$each', '$==', '$uses_count', '$sub', '$id', '$prop_type', '$gsub', '$name', '$to_var']);
  return (function($base) {
    var $PropTypes, self = $PropTypes = $module($base, 'PropTypes');
    ...
    (function($base, $super) {
      function $ShapeCache(){};
      var self = $ShapeCache = $klass($base, $super, 'ShapeCache', $ShapeCache);
      ...
      Opal.defn(self, '$initialize', function() {
        ...
        return self.storage = $hash2([], {});
      });

      Opal.defn(self, '$cache', TMP_1 = function(props) {
        var $a, $b, $c, $d, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, cache_key = nil;

        TMP_1.$$p = null;
        cache_key = props.$keys().$sort().$join(",");
        return ($a = cache_key, $b = self.storage, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, ((($d = Opal.yieldX($yield, [])) === $breaker) ? $breaker.$v : $d))));
      });

      return (Opal.defn(self, '$apply_shapes', function(base_shape) {
        var $a, $b, TMP_2, self = this, shapes = nil;

        shapes = self.storage.$values().$reverse();
        ($a = ($b = shapes).$each, $a.$$p = (TMP_2 = function(cached_shape){var self = TMP_2.$$s || this;
if (cached_shape == null) cached_shape = nil;
        if (cached_shape.$uses_count()['$=='](1)) {
            return base_shape = base_shape.$sub(cached_shape.$id(), cached_shape.$prop_type())
            } else {
...
Opal.modules["prop_types"] = function(Opal) {
  ...
  self.$require("json");
  self.$require("prop_types/cached_shape");
  self.$require("prop_types/destructure");
  self.$require("prop_types/generator");
  self.$require("prop_types/indent");
  self.$require("prop_types/shape_cache");
  return (function($base) {
    var $PropTypes, self = $PropTypes = $module($base, 'PropTypes');
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require']);
  self.$require("opal");
  return self.$require("prop_types");
})(Opal);
